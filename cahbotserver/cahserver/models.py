...
class MamMovie(models.Model):
    ...
    mentions_first = models.ManyToManyField(MamColaborator, blank=True, related_name='movie')
    mentions_other = models.ManyToManyField(MamColaborator, blank=True, related_name='movie')
